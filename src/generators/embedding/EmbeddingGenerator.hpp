...
public:
    ...
    /**
     * @brief Generate dependency embeddings, labels, and vertex pairs.
     *
     * @param vertex_to_index The map of vertex to index.
...
private:
     ...
     *
     * This function creates all possible vertex pairs and labels for the given vertex
     * map. Returned tensors are in the same order as the vertex pairs.
