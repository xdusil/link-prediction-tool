...
void RandomForestClassifier<Features, Labels, AverageType, Scaler>::save(
    ...
    try {
        ...
        // Serialize all data - const_cast is OK because serialize will not modify the
        // object (use only output archive)
        const_cast<RandomForestClassifier *>(this)->serialize(archive);
